...
public class RestaurantListAdapter extends ArrayAdapter<Restaurant> {
    ...
    public RestaurantListAdapter(Context context, List<Restaurant> restaurantList, OnRestaurantClickListener clickListener) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        convertView.setOnClickListener(v -> clickListener.onRestaurantClick(restaurant));
